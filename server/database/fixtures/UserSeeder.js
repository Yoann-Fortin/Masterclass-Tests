...
class UserSeeder extends AbstractSeeder {
  ...
  run() {
    ...
    for (let i = 0; i < 10; i += 1) {
      ...
      const fakeUser = {
        firstName: this.faker.person.firstName(), // Generate a fake firstName using faker library
        lastName: this.faker.person.lastName(), // Generate a fake lastName using faker library
